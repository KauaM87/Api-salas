...
# Mudado o padrão para 0.25 (ponto ideal para modelos customizados)
...
def _inferir(caminho_imagem: str) -> dict:
    ...
    # AJUSTE AQUI: Adicionado imgsz=1024 para o YOLO não reduzir e perder os objetos pequenos da planta
    results = model(img, conf=CONF_THRESHOLD, device=_device, imgsz=1024, verbose=False)
    itens_detectados = []
